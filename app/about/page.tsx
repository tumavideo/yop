    ...
    <div className="bg-white">
      <div className="container px-4 mx-auto pt-10 space-y-12 md:space-y-0 md:flex-row max-w-7xl">
        ...
        <div className="mx-auto md:w-3/4">
          <h1 className="text-center font-bold text-[50px] mb-5" style={{lineHeight: 1.2}}>About Inlight Zambia</h1>
      ...
      <div className="container flex flex-col px-4 mx-auto mt-10 space-y-12 md:space-y-0 md:flex-row max-w-7xl" style={{marginTop: 160}}>
        ...
        <div className="flex flex-col md:w-1/2 my-auto">
          <div className="my-auto">
            <h1 className="font-bold text-[50px] mb-5" style={{lineHeight: 1.2}}>Why InLight Zambia?</h1>
