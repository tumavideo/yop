...
export default function CTA({
  company = false,
  title = "Get started",
  description = "Looking to showcase an opportunity? Start today and empower a brighter future",
}) {
  return company ? (
    <div
      className="relative flex flex-col bg-orange-500 rounded-0 md:rounded-md"
      style={{ background: "#DF912F" }}
    >
      ...
      <div className="md:w-6/12 w-12/12">
        <img
          className="md:w-5/12 w-full md:absolute md:right-0 md:bottom-0"
          src={assets.man_job.src}
          alt="logo"
        />
      </div>
    </div>
    ...
    >
      ...
      <div className="md:w-5/12 w-12/12">
        <img
          className="md:w-3/12 md:absolute md:right-0 md:bottom-0 mx-auto md:mr-40"
          src={assets.wow_job.src}
          alt="logo"
        />
      </div>
    </div>
