                          ...
                          <div>
                            ...
                            <div className="mt-1 flex rounded-md shadow-sm">
                              ...
                              <input
                                ...
                                className="block w-full min-w-0 flex-grow rounded-none rounded-r-md border-gray-300 focus:border-blue-500 focus:ring-blue-500 sm:text-sm"
                          ...
                          <div className="mt-1 lg:hidden">
                            <div className="flex items-center">
                              ...
                              <div className="ml-5 rounded-md shadow-sm">
                                <div className="group relative flex items-center justify-center rounded-md border border-gray-300 py-2 px-3 focus-within:ring-2 focus-within:ring-blue-500 focus-within:ring-offset-2 hover:bg-gray-50">
                                  <label
