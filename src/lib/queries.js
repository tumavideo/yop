export const findOpportunities = (count = "5") => `{
  "job": *[_type == "job" && !(_id in path('drafts.**'))]{_id,_createdAt,position,description,location,qualifications,closingDate,enableApply,link,responsibilities,role,slug,title,companyRef->{company,bio,logo}} | order(_createdAt desc)[0..${count}],
