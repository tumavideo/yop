    ...
    <div className="Pagination">
      ...
      >
        ...
        <div className="hidden md:-mt-px md:flex">
          <a
            href="#"
            className="inline-flex items-center border-t-2 border-transparent border-indigo-500 px-4 pt-4 text-sm font-medium text-gray-500 text-indigo-600  hover:border-gray-200 hover:text-gray-700"
          >
            1
          </a>
