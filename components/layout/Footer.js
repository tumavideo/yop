...
const navigation = {
  ...
  social: [
    ...
    {
      name: "Twitter",
      href: "https://twitter.com/InLightZambia",
      icon: (props) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
...
export default function Footer() {
  return (
    ...
    >
      ...
      <div className="mx-auto max-w-7xl px-6 pt-10 sm:pt-24 lg:px-8">
        ...
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          ...
          <div className="mt-10 xl:mt-0">
            ...
            <div className="flex mt-5 mb-8 md:mb-0">
      ...
      >
        <div className="md:flex mx-5 lg:mx-auto md:items-center md:justify-between container">
